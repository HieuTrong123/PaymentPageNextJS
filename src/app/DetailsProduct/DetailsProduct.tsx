    ...
    <div className={classes.box_padding}>
      <div className={`grid wide ${classes.container}`}>
        <div className={classes.head}>
          ...
          >
            <Image src={backBtn} alt="error" width={372} height={288} />
          </button>
        ...
        <div className={`${classes.listInfoOn} ${classes.box_flex}`}>
          ...
          <ul className={classes.listInfo}>
            ...
            <InfoITem
              title="Chất liệu"
              content={product.material.name || "không"}
            />
            ...
            <InfoITem
              darkColor={true}
              title="Tổng tiền"
              content={(product.number * product.money).toLocaleString(
                "it-IT",
        ...
        >
          ...
          hệ số điện thoại/ zalo : {customer.assign.phone} để được nhân viên hỗ
          trợ
        </p>
      </div>
    </div>
